...
public abstract class BaseSynthsiser {
     ...
     * @param fragments
     *            List<String> that you want to add stuff too. If you don't have a List<String> already constructed "new ArrayList<String>()" works
     *            well.
    ...
    /**
     * Finds the last word in your String (before the index of 99) by searching for spaces and ending punctuation. Will preferably parse on
     * punctuation to alleviate mid-sentence pausing
     *
     * @param input
    ...
    /**
     * Checks if char is an ending character Ending punctuation for all languages according to Wikipedia (Except for Sanskrit non-unicode)
     *
     * @param input
     *            The char you want check
    ...
    /**
     * This class is a callable. A callable is like a runnable except that it can return data and throw exceptions. Useful when using futures.
...
//*******************************************************************************/ public abstract class BaseSynthsiser { /**
// VIETNAMESE
// ************************************************** ***************************** / lớp trừu tượng công khai BaseSynthsiser { / **
